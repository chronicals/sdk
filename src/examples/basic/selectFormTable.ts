import { ChronicalsActionHandler } from '../..'
...
export const table_basic: ChronicalsActionHandler = async io => {
...
export const table_actions: ChronicalsActionHandler = async io => {
...
export const table_custom_columns: ChronicalsActionHandler = async io => {
