...
import { ChronicalsActionHandler, io } from '../../index'
...
export const no_images: ChronicalsActionHandler = async io => {
  const data = Array(50)
    .fill(null)
    .map((_, i) => ({
      id: i,
...
export const only_images: ChronicalsActionHandler = async io => {
  const data = Array(50)
    .fill(null)
    .map((_, i) => ({
      id: i,
...
export const async_grid: ChronicalsActionHandler = async io => {
