...
export const paginated: ChronicalsActionHandler = async io => {
...
export const empty: ChronicalsActionHandler = async io => {
  const data = generateRows(5)
...
export const display_table: ChronicalsActionHandler = async io => {
...
export const multiple_tables: ChronicalsActionHandler = async io => {
  await io.group([
...
export const async_table: ChronicalsActionHandler = async () => {
  await asyncTable(500)
}

export const select_table: ChronicalsActionHandler = async io => {
  faker.seed(0)
...
export const table_custom: ChronicalsActionHandler = async io => {
  const options = [
    'id',
    'name',
    'email',
...
export const image_viewer: ChronicalsActionHandler = async io => {
  const data = Array(50)
    .fill(null)
    .map((_, i) => {
